...
import static crml.compiler.crmlcv2.templates.value.ValueGenUtil.comparisonToBoolean4;
import static crml.compiler.crmlcv2.templates.value.ValueGenUtil.incompatibleTypes;
import static crml.compiler.crmlcv2.templates.value.ValueGenUtil.infix;
import static crml.compiler.crmlcv2.templates.value.ValueGenUtil.involvesClockOrPeriod;
...
import static crml.compiler.crmlcv2.templates.value.ValueGenUtil.isStringCompatible;
