...
import crml.compiler.translation.Signature.Type;
...
public class OperatorMapping {
  ...
  public static HashMap<String, List<Signature>> get_operator_map() {
    ...
    // - operators
    List<Signature> minus_sigs = Arrays.asList(new Signature("-", int2, "Integer", Type.OPERATOR),
      new Signature("-", int1, "Integer", Type.OPERATOR),
      new Signature("-", real1, "Real", Type.OPERATOR),
      new Signature("-", real2, "Real", Type.OPERATOR),
    ...
    // / operators
    List<Signature> div_sigs = Arrays.asList(new Signature("/", int2, "Integer", Type.OPERATOR),
      new Signature("/", real2, "Real", Type.OPERATOR),
    ...
    // ^ operators
    List<Signature> expo_sigs = Arrays.asList(new Signature("^", int2, "Integer", Type.OPERATOR),
      new Signature("^", realint, "Real", Type.OPERATOR));
    
    built_in_operators.put("^", expo_sigs);

    // <= operators
    List<Signature> leq_sigs = Arrays.asList(new Signature("<=", int2, "Boolean", Type.OPERATOR),
    ...
    // < operators
    List<Signature> le_sigs = Arrays.asList(new Signature("<", int2, "Boolean", Type.OPERATOR),
      new Signature("<", real2, "Boolean", Type.OPERATOR),
      new Signature("<", intreal, "Boolean", Type.OPERATOR),
      new Signature("<", realint, "Boolean", Type.OPERATOR),
    ...
    // >= operators
    List<Signature> geq_sigs = Arrays.asList(new Signature(">=", int2, "Boolean", Type.OPERATOR),
      new Signature(">=", real2, "Boolean", Type.OPERATOR),
      new Signature(">=", intreal, "Boolean", Type.OPERATOR),
      new Signature(">=", realint, "Boolean", Type.OPERATOR),
    ...
    // > operators
    List<Signature> gr_sigs = Arrays.asList(new Signature(">", int2, "Boolean", Type.OPERATOR),
      new Signature(">", real2, "Boolean", Type.OPERATOR),
      new Signature(">", intreal, "Boolean", Type.OPERATOR),
      new Signature(">", realint, "Boolean", Type.OPERATOR),
    ...
    // == operators
    List<Signature> eq_sigs = Arrays.asList(new Signature("==", int2, "Boolean", Type.OPERATOR),
      new Signature("==", real2, "Boolean", Type.OPERATOR),
      new Signature("==", intreal, "Boolean", Type.OPERATOR),
      new Signature("==", realint, "Boolean", Type.OPERATOR),
    ...
    // <> operators
    List<Signature> neq_sigs = Arrays.asList(new Signature("<>", int2, "Boolean", Type.OPERATOR),
      new Signature("<>", real2, "Boolean", Type.OPERATOR),
      new Signature("<>", intreal, "Boolean", Type.OPERATOR),
      new Signature("<>", realint, "Boolean", Type.OPERATOR),
    ...
    // cos operators
    List<Signature> cos_sigs = Arrays.asList(new Signature("Modelica.Math.cos", int1, "Real", Type.FUNCTION),
      new Signature("Modelica.Math.cos", real1, "Real", Type.FUNCTION));

    built_in_operators.put("cos", cos_sigs);

    // acos operators
    List<Signature> acos_sigs = Arrays.asList(new Signature("Modelica.Math.acos", int1, "Real", Type.FUNCTION),
      new Signature("Modelica.Math.acos", real1, "Real", Type.FUNCTION));

    built_in_operators.put("acos", acos_sigs);

    // sin operators
    List<Signature> sin_sigs = Arrays.asList(new Signature("Modelica.Math.sin", int1, "Real", Type.FUNCTION),
      new Signature("Modelica.Math.sin", real1, "Real", Type.FUNCTION));

    built_in_operators.put("sin", sin_sigs);

    // asin operators
    List<Signature> asin_sigs = Arrays.asList(new Signature("Modelica.Math.asin", int1, "Boolean", Type.FUNCTION),
      new Signature("Modelica.Math.asin", real1, "Boolean", Type.FUNCTION));

    built_in_operators.put("asin", asin_sigs);

    // exp operators
    List<Signature> exp_sigs = Arrays.asList(new Signature("Modelica.Math.exp", int1, "Real", Type.FUNCTION),
      new Signature("Modelica.Math.exp", real1, "Real", Type.FUNCTION));

    built_in_operators.put("exp", exp_sigs);

    // mod operators
    List<Signature> mod_sigs = Arrays.asList(new Signature("Modelica.Math.exp", int2, "Integer", Type.FUNCTION),
    ...
    // log operators
    List<Signature> log_sigs = Arrays.asList(new Signature("Modelica.Math.log", int1, "Real", Type.FUNCTION),
      new Signature("Modelica.Math.log", real1, "Real", Type.FUNCTION));

    built_in_operators.put("log", log_sigs);

    // log10 operators
    List<Signature> log10_sigs = Arrays.asList(new Signature("Modelica.Math.log10", int1, "Real", Type.FUNCTION),
  ...
  public static Signature is_defined(HashMap<String, List<Signature>> operator_map, String op, String type1,
    ...
    for (Signature s : sigs) 
      if (s.variable_types.size() == 2 && s.variable_types.get(0).equals(type1)
