...
import crml.compiler.omcv2.util.LineMerger;
...
public class PeriodsGen {
    public static String generate(PeriodsValue periods){
        ...
        lines.add("    start="+ValueGen.generate(periods.getStartValue())+",");
        lines.add("    close_event="+ValueGen.generate(periods.getEndValue()));
        lines.add(");");
