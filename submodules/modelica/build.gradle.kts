...
dependencies {
    ...
    // Declared api so dependents (e.g. :compiler) get EObject, EList, etc.
...
tasks.register<JavaExec>("generateGenModel") {
    ...
    description = "Generates EMF GenModel for the Modelica and trace metamodels"

    val outputFile = layout.buildDirectory.file("generated/modelica.genmodel")

    outputs.file(outputFile)

    classpath = sourceSets.main.get().runtimeClasspath
    mainClass.set("crml.modelica.GenmodelMain")
