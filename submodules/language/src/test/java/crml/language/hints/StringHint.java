...
public class StringHint extends BaseSpecificationTest {
        
    static List<String> fileNameSource() throws IOException {
        return MarkdownExtractor.extractCrmlBlocks(RESOURCES.resolve("../../../../../../").normalize().resolve("documentation/llm_hints/string_type.md"));
    }
