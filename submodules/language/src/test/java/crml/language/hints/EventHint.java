...
public class EventHint extends BaseSpecificationTest {
        
    static List<String> fileNameSource() throws IOException {
        return MarkdownExtractor.extractCrmlBlocks(RESOURCES.resolve("../../../../../../").normalize().resolve("documentation/llm_hints/event_type.md"));
    }
