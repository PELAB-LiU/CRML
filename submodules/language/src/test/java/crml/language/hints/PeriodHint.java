...
public class PeriodHint extends BaseSpecificationTest {
        
    static List<String> fileNameSource() throws IOException {
        return MarkdownExtractor.extractCrmlBlocks(RESOURCES.resolve("../../../../../../").normalize().resolve("documentation/llm_hints/period_periods_types.md"));
    }
